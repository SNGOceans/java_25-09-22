...
public class BankController implements BankProgram {
    ...
    public BankController() {
        ...
        bank.get(0).addCustomer(new Customer(bank.get(0).getBankName(), "이서연", "ACC1003", 25000));
        bank.get(1).addCustomer(new Customer(bank.get(1).getBankName(), "홍길동", "ACC1001", 20000));
        bank.get(1).addCustomer(new Customer(bank.get(1).getBankName(), "김철우", "ACC1002", 30000));
        bank.get(0).addCustomer(new Customer(bank.get(0).getBankName(), "최지훈", "ACC1004", 40000));
        bank.get(0).addCustomer(new Customer(bank.get(0).getBankName(), "정유진", "ACC1005", 18000));
    }
    ...
    public Customer getMyBank() {
        return myBank;
    }

    public void setMyBank(Customer myBank) {
        this.myBank = myBank;
    }
}