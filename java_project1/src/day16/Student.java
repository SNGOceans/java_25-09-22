...
public class Student {
	...
	public void printStudent() {
		...
		for(int i=0; i<nameList.size(); i++) {
			System.out.println("학생 "+(i+1)+": "+nameList.get(i)+" | 점수: "+scoreList.get(i));
		}
	}
	...
	public void printStat() {
		...
		int over80 = (int) scoreList.stream()
								    .filter(n -> n>=80)
								    .count();
    ...
    public void sortByScore() {
        ...
        System.out.println("점수 기준 내림차순 정렬 완료!");
    }
    ...
    public int menuPrint(Scanner scan) {
        System.out.println("\n-- menu --");
        System.out.println("1. 학생 등록 |2. 학생 리스트 |3. 통계 | "
        				    + "\n4. 이름 순 정렬 |5. 점수 정렬(내림차순) |6. 종료");
        System.out.print("선택: ");
        return scan.nextInt();
    }
