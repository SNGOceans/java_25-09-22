...
public class Class01 {
	 ...
	 * - 멤버변수를 다른 클래스에서 접근 가능하도록 메서드를 만들어서 사용(getter/setter).
	 *   - 왜 이렇게 할까? 고유성을 지키기 위해서. 코드가 엄청 긴데, 모든 멤버변수 명을 다 다르게 할 수 없다.
	 *   - 멤버 변수와 일반 변수를 헷갈리지 않기 위해서 this.를 붙여준다.
	 * */
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Test t = new Test();
		//setter 경우 메서드이기 때문에 매개변수로 주어야 한다.
		t.setX(10);
		t.setY(20);		
