...
public class Method02 {
	...
	public void addprint(int num1, int num2) {
		int result = 0;
		//result = num1 + num2;
		result = add(num1,num2); //main을 제외한 메서드 내부에서 다른 메서드를 호출 가능함. (static이 없더라도)
	...
	public static void main(String[] args) {
		...
		Method02 m = new Method02(); // main 안에서 클래스를 객체화
		m.addprint(numbers[0], numbers[1]);
		
//		Method02 arb = new Method02();
//		result = arb.sum4();
		//System.out.println(result);
	}
